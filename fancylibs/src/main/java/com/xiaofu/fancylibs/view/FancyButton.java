...
public class FancyButton extends View {
    ...
    public FancyButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mTagShape = a.getInteger(R.styleable.FancyButton_fb_shape, FancyButton.SHAPE_ROUND_RECT);
            mBgColor = a.getColor(R.styleable.FancyButton_fb_bg_color, Color.parseColor("#f44f4f"));
            mBorderColor = a.getColor(R.styleable.FancyButton_fb_border_color, Color.parseColor("#f44f4f"));
            mTextColor = a.getColor(R.styleable.FancyButton_fb_text_color, Color.WHITE);
            mPressedColor = a.getColor(R.styleable.FancyButton_fb_hover_color, Color.parseColor("#cf3a3a"));
            mDisabledColor = a.getColor(R.styleable.FancyButton_fb_disabled_color, Color.parseColor("#cccccc"));
            mBorderWidth = (int) a.getDimension(R.styleable.FancyButton_fb_border_width, MeasureUtils.dp2px(context, 1f));
            mRadius = (int) a.getDimension(R.styleable.FancyButton_fb_border_radius, MeasureUtils.dp2px(context, 5f));
            mTextSize = (int) a.getDimension(R.styleable.FancyButton_fb_text_size, MeasureUtils.sp2px(context, 14f));
